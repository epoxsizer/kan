...
func createRoadmapBoard(ctx context.Context, repo domain.Repository, projectID, boardID string, position float64) error {
	...
	cards := []domain.Card{
		...
		{ID: demoID(boardID, 22), BoardID: boardID, ColumnID: columns[2].ID, Title: "Release v0.1.1", Description: "Publish binaries and checksums.", Position: 1024, Tags: []string{"release"}, Fields: map[string]domain.FieldValue{}},
	}
